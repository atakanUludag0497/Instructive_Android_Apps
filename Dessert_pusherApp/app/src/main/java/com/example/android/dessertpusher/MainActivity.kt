...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState != null){
            ...
            //dessertTimer = savedInstanceState.getInt(KEY_DESSERTTIMER)
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Timber.i("save_On_instance_state called by Timber...")
    }
    ...
    override fun onResume() {
        ...
        Timber.i("onResume called by Timber...")
    }

    override fun onPause() {
        super.onPause()
        //Log.i("MainActivity","onPause called")
        Timber.i("onPause called by Timber...")
    ...
    override fun onStop() {
        ...
        Timber.i("onStop called by Timber...")
    }

    override fun onDestroy() {
        super.onDestroy()
        //Log.i("MainActivity","onDestroy called")
        Timber.i("onDestroy called by Timber...")
    }
}